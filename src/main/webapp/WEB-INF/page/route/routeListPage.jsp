	...
	<body>
		 <div class="js_box">
          <div class="js_tit clearfix">
            <div class="fy_w"><a href="#">${page.current}/${page.pageNum }页 </a>
            <%-- <c:if test="${currentPage}>1"> --%>
            	<a href="#" onclick="queryPage('${page.previous}')">上一页</a>
            <%-- </c:if> --%>
            <%-- <c:if test="${currentPage}&lt;${pageNum}"> --%>
            	<a href="#" onclick="queryPage('${page.next}')">下一页</a> 
            <%-- </c:if> --%>
            </div>
          </div>
		 <div class="js_wrap claerdix">
            ...
            <div class="js_con clearfix">
               <div class="js_l"><a href="${path }/route/routeDetail?id=${rou.id}"><img src="${path }/img/${rou.image }" style="width: 100px;height: 75px"></a></div>
              <div class="js_c">
