...
<%@ include file="/WEB-INF/page/route/mainNav.jsp" %>
<div class="b_wrap">
    <div class="current"><span>当前所在地：</span><a href="${path }/route/routeList">旅游路线</a>>> <a href="${path }/route/routeDetail?id=${route.id}">${route.routeName}</a> </div>
    <div class="clumn_w clearfix">
        <div class="clumn_l">
            ...
            <div class="clumn">
                ...
                <div class="clumn_con">
                    ...
                    <div><center><img src="${path }/images/add01.jpg"></center></div>
                </div>
            </div>
            <div class="clumn">
        ...
        <div class="clumn_r">
            ...
            <div class="xq_wrap clearfix">
              <div class="xq_left"><img src="${path }/img/${route.image}" style="width: 370px;height: 330px"></div>
              <div class="xq_right">
                <div class="xq_detail">
                  ...
                  <p>出团日期：<fmt:formatDate value="${route.startTime }" pattern="yyyy-MM-DD"/> - <fmt:formatDate value="${route.endTime }" pattern="yyyy-MM-DD"/> </p>
            ...
            <div class="xq_wrap">
              ...
              <div class="tab_box"> 
                   <div class="tab_w">
                     ...
                     <div class="jd_clum">
                       <div class="jd_tit">第${routeD.day }天 ${routeD.startPlace } — ${routeD.endPlace }</div>
                       <div class="jd_con">
                       ...
                       <div class="jd_dl clearfix">
                       	...
                       	<dl class="mr16">
                           <dt><img src="${path }/img/${routeD.image}" style="width: 670px;height: 657px"></dt>
                      ...
                      <div class="jd_con01">
                         ...
                         <p><span>结束愉快行程，返回${route.endPlace }。</span></p>
