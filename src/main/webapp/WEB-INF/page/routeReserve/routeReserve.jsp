            	...
            	<div class="fxc">
                    ...
                    <div class="fxc2">
                    	<table border="0" cellpadding="0" cellspacing="0" width="670">
                        	<tr>
                                ...
                                <td width="600" align="left" height="30"><span class="fxcspan1">${route.routeName }</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="600" align="left" height="30"><fmt:formatDate value="${route.startTime }" pattern="yyyy-MM-DD"/></td>
                            </tr>
                            <tr>
                            	<td width="70" align="left" height="30">人数：</td>
                                <td width="600" align="left" height="30"><select><option>1</option><option>2</option><option>3</option></select>&nbsp;成人&nbsp;<select><option>0</option><option>1</option><option>2</option></select>&nbsp;儿童&nbsp;&nbsp;<span class="fxcspan2"><a href="#">查看儿童标准</a></td>
                            </tr>
                        </table>
                    </div>
                    <div class="fxc1">上车地点</div>
                    <div class="fxc2">
                    	<table border="1" bordercolor="#e4e4e4" cellpadding="0" cellspacing="1" width="670">
                        	<tr bgcolor="#e4e4e4">
                            ...
                            <tr bgcolor="#fff">
                            	<td width="167" align="center" height="30"><input type="radio">&nbsp;06:40</td>
                    ...
                    <div class="fxc2">
                    	<table border="1" bordercolor="#e4e4e4" cellpadding="0" cellspacing="1" width="670">
                            ...
                            <tr bgcolor="#fff">
                            	<td width="94" align="center" height="94"><input type="checkbox">&nbsp;保险</td>
                                <td width="200" align="center" height="200">太平国内自由行2日游意外险(特惠型)</td>
                                <td width="94" align="center" height="94"><span class="fxcspan2">￥13</span></td>
                                <td width="94" align="center" height="94"></td>
                                <td width="94" align="center" height="94"><select><option>0</option></select></td>
                                <td width="94" align="center" height="94"><span class="fxcspan2">￥0</span></td>
                            </tr>
                    ...
                    <div class="fxc2">
                    	<table border="0" cellpadding="0" cellspacing="0" width="670">
                        	<tr>
                            	<td height="20">
                                    <input type="radio" align="absmiddle">&nbsp;&nbsp;不需要发票&nbsp;
                                    <span class="fxcspan2">如您出游归来后需要发票，可以在两个月内前往会员中心-查看订单中填写发票信息，索取发票</span>
                                </td>
                             </tr>
                             <tr>
                                <td height="20">
                                    <input type="radio" align="absmiddle">&nbsp;&nbsp;需要发票&nbsp;
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="fxc2">
                        ...
                        实时计价机票价格调整除外）；<br>
                        2、正常阴雨天气不影响正常出游，如遇不可抗逆因素导致不能出游我司会提前与您联系；<br>
                        3、您完成预订后，我在出游前一天20：00，通过短信将上车时间、地点、上车凭证、导游联系方式发送给您，请保持手机畅通；<br>
                        4、如您预订的出游日期最终不成团，我司会提前与您沟通解决方案，届时您可以选择改期出游、更改出游产品或由我司按合同赔
                        偿违约金；
                    </div>
                    <div class="fxc1">出游费用包含</div>
                    <div class="fxc2">
                    	1.交通：往返旅游巴士。<br>
                        2.住宿：千岛湖海外海假日酒店1晚含早。<br>
                    ...
                    <div class="fxc2">
                    	1.单房差。<br>
                        2.门票：行程中注明需要另行支付的自费景点（行程包含中以外客人自愿参加的当地娱乐项费用）。<br>
                        3.其他：正餐自理。<br>
                        4.因交通延阻、罢工、天气、飞机机器故障、航班取消或更改时间等不可抗力原因所引致的额外费用。<br>
                        5.酒店内洗衣、理发、电话、传真、收费电视、饮品、烟酒等个人消费。<br>
                        6.当地参加的自费以及以上“费用包含”中不包含的其它项目。<br>
                        7.旅游人身意外保险
                    </div>
                    <div class="fxc3">违约责任提示</div>
                    <div class="fxc2">
                    	1. 出发前7天至4天（含第7天）改期、换线或退团， 需按合同支付旅游费用总额50%；<br>
						2. 出发前3天至1天（含第3天）改期、换线或退团， 需按合同支付旅游费用总额60%；
                    </div>
                    <div class="fxc1">
                   <a href="行程导航 -我要预订.html">
                    <input type="image" src="${path }/images/fxcbtn1.png"></a></div>
                </div>
            </div>
        </div>
        <br style="clear:both">
