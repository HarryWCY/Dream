...
<%@ include file="/WEB-INF/page/routeReserve/mainNav.jsp" %>

<div class="b_wrap">
    <div class="current"><span>当前所在地：</span><a href="中国梦想游首页.html">首页</a> >> <a href="行程导航-详情.html">行程导航</a> >> <a href="#">产品详情</a></div>
    <div class="clumn_w clearfix">
                ...
                <table width="710" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td width="630"><input class="it_p"  type="text" name="" value="" placeholder=""></td>
                        </tr>
                        <tr>
                          <td align="right">  身份证号：</td>
                          <td><input class="it_p"  type="text" name="" value="" placeholder=""></td>
                        </tr>
                        <tr>
                          <td align="right">姓名：</td>
                        <td><input class="it_p"  type="text" name="" value="" placeholder="">
                              <label>
       ...
       <div class="trans_con">
            ...
            <p style="font-weight:bold;font-size:14px;">中秋节礼品 大山合百菇园秋月款A菌菇礼盒 干货大礼包土特产送礼</p>
            <p><b>支付宝帐号</b>（fmwl@163.com） 可支付余额：<b style="color:#f60;">200.00元</b></p>
            <p><span class="fk_s">您的账户没有可支付余额，请使用以下其他方式付款，或<a style="color:#006eb4;" href="#">充值</a>后付 </span><span class="price_s">¥455.10</span></p>
       </div>
       <div class="sp_bz"><img src="${path }/images/baoz.jpg"></div>
    </div>
    <div class="fk_wrap">
        ...
        <div class="fk_con">
            <div class="fk_bank">
                <div class="fk_tw clearfix">
                    <div class="fn-left"><img src="${path }/images/kj_zf.jpg"></div>
                ...
                <table class="tj_bank" width="660" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody>
                        <tr>
                            <td><label><input type="radio" name="RadioGroup1" value="单选" id="RadioGroup1_0"></label>
                                <div class="xz_yx">
                                    <div class="yh_zp"><img src="${path }/images/bank01.jpg"></div>
                                    <div class="yh_xc"><span>惠</span>100减10</div>
                                <div>
                            </div></div></td>
                            <td><label><input type="radio" name="RadioGroup1" value="单选" id="RadioGroup1_3"></label>
                                <div class="xz_yx">
                                    <div class="yh_zp"><img src="${path }/images/bank02.jpg"></div>
                                    <div class="yh_xc"><span>惠</span>100减10</div>
                                <div>
                            </div></div></td>
                        </tr>
                         <tr>   <td><label><input type="radio" name="RadioGroup1" value="单选" id="RadioGroup1_2"></label>
                                <div class="xz_yx">
                                    <div class="yh_zp"><img src="${path }/images/bank01.jpg"></div>
                                    <div class="yh_xc"><span>惠</span>100减10</div>
                                <div>
                            </div></div></td>
                            <td><label><input type="radio" name="RadioGroup1" value="单选" id="RadioGroup1_1"></label>
                                <div class="xz_yx">
                                    <div class="yh_zp"><img src="${path }/images/bank01.jpg"></div>
                        ...
                        <tr>
                            <td><label><input type="radio" name="RadioGroup1" value="单选" id="RadioGroup1"></label>
                                <div class="xz_yx">
                                    <div class="yh_zp"><img src="${path }/images/bank05.jpg"></div>
                                    <div class="yh_xc"><span>惠</span>100减10</div>
                                <div>
                            </div></div></td>
                            <td><label><input type="radio" name="RadioGroup1" value="单选" id="RadioGroup3"></label>
                                <div class="xz_yx">
                                    <div class="yh_zp"><img src="${path }/images/bank06.jpg"></div>
                                    <div class="yh_xc"><span>惠</span>100减10</div>
                                <div>
                            </div></div></td>
                        </tr><tr>
            ...
            <div class="next_b"><a href="#"><img src="${path }/images/next.jpg"></a></div>
        </div>
    </div>
        </div>
    </div>
