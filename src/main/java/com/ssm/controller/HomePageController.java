...
public class HomePageController {
	...
	@Autowired
	private SpecialtyService specialtySerive;
	@RequestMapping(value = "/index")
	public String begin(Model model,RouteVo routeVo,SpecialtyVo specialtyVo) throws Exception{
		PageBean<Route> pageBean1 = routeService.queryPageByCondition(1, 4, routeVo);
		PageBean<Specialty> pageBean2 = specialtySerive.queryPageByCondition(1, 8, specialtyVo);
